...
- (void)viewDidLoad
{
    ...
    self.introduceLabel.textColor = [ColorManager sharedColorManager].fontDeepColor;
    ...
    [self.cancelBtn setBackgroundColor:[ColorManager sharedColorManager].themeColor];
    [self.cancelBtn.layer setMasksToBounds:YES];
    [self.cancelBtn.layer setCornerRadius:5.0];
    self.cancelBtn.frame = CGRectMake((SCREEN_FRAME.size.width-120)/2,SCREEN_HEIGHT - 100, 120, 40);
